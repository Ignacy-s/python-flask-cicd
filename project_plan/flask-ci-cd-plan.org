...
** DONE Write Terraform code that deploys to the cloud, not worrying about secrets and permissions at first
CLOSED: [2024-06-20 Thu 14:36]
...
**** TODO Create an ECS Cluster with Terraform
**** TODO Write a Task Definition
**** TODO Re-use the Jenkins' network if it's possible
