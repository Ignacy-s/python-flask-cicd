...
* TODO Set up Jenkins part 2: install Jenkins using Ansible.
...
** TODO Create a playbook based on the instructions
** Debug the playbook until it deploys a working Jenkins server
