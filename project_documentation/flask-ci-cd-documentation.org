...
CLOSED: [2023-09-20 Wed 19:18]
** TODO Update Ansible playbook knowing what was missing from the server:
*** TODO Summary: How do I need to modify my Ansible playbook?
...
*** Add jenkins user to docker group, !! jenkins service shouldn't be started before jenkins is added to the docker group !!
